public class Bishop extends Piece {
    ...
    public Bishop(int x, int y, boolean is_white, ChessBoard board) {
        super(x, y, is_white, board);
    }

    @Override
    void setWhite_img_file_path() {
        this.white_img_file_path= "untitled/images/WhiteBishop.png";
    }

    @Override
    void setBlack_img_file_path() {
        this.black_img_file_path = "untitled/images/BlackBishop.png";
    }
